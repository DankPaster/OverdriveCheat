...
public:
	...
	CBaseWeapon* GetClientEntity_Weapon(int Index)
	{
		typedef CBaseWeapon*(__thiscall* Fn)(void*, int);
		return ((Fn)VMT.GetFunction(this, 3))(this, Index);
	}
	...
	CBaseWeapon* GetClientEntityFromHandle_Weapon(HANDLE Handle)
	{
		typedef CBaseWeapon*(__thiscall* Fn)(void*, HANDLE);
		return ((Fn)VMT.GetFunction(this, 7))(this, Handle);
	}
};