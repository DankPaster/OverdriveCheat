...
public:
	...
	bool IsMoving()
	{
		if (m_vecVelocity().Length2D() > 1) return true;
		else return false;
	}
	...
	CBaseWeapon* m_hActiveWeapon()
	{
		return *(CBaseWeapon**)((uintptr_t)this + 0x2EE8);
	}

	CBaseWeapon* m_hMyWeapons()
	{
		return *(CBaseWeapon**)((uintptr_t)this + 0x2DE8);
	}
